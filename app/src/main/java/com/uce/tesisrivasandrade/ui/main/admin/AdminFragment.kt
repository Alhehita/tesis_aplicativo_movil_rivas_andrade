...
class AdminFragment : Fragment(R.layout.fragment_admin) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        cardLaboratorios?.setOnClickListener {
            findNavController().navigate(R.id.action_adminFragment_to_gestionLaboratoriosFragment)
        }

        cardEquipos?.setOnClickListener {
            findNavController().navigate(R.id.action_adminFragment_to_gestionEquiposFragment)
        }

        cardNovedades?.setOnClickListener {
            findNavController().navigate(R.id.action_adminFragment_to_novedadesFragment)
        }

        cardRegistros?.setOnClickListener {
            findNavController().navigate(R.id.action_adminFragment_to_registroUsoMenuFragment)
        }
    }
}
